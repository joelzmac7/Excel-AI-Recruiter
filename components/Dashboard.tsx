...
const Dashboard: React.FC<DashboardProps> = ({ metrics, nudges }) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <button className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div className="text-left">
                            <div className="font-medium text-gray-900">Add Candidate</div>
                            <div className="text-sm text-gray-500">Bookmark new candidate</div>
                        </div>
                    </button>
